...
QUnit.moduleDone = function (opts) {
  if (opts.failed === 0) {
    console.log("\u2714 All test passed in '" + opts.name + "' module")
  } else {
    console.log("\u2716 " + opts.failed + " test failed in '" + opts.name + "' module")
  }
}
...
QUnit.done = function (opts) {
  ...
  console.log(opts.passed + " test of " + opts.total + " passed, " + opts.failed + " failed.")
}*/
